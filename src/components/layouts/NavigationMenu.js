  ...
  return (
    <>
      <nav
        ...
        } col-end-3 row-start-1 row-end-2 bg-primary-dark shadow atlancolor`}
      >
      ...
      {isOpen && (
        <div className="relative col-start-1 col-end-2 row-start-1 row-end-5 ">
          <div className="bg-secondary-dark text-white w-72 px-3 fixed top-0 bottom-0 z-50 min-h-screen overflow-y-auto atlancolordark">
            <svg
              xmlns="http://www.w3.org/2000/svg"
